...
exports.OtpInput = (0, react_1.forwardRef)((props, ref) => {
  ...
  } = (0, useOtpInput_1.useOtpInput)(props);
  const {
    numberOfDigits = 6,
    autoFocus = true,
    hideStick,
  ...
  return (
    <react_native_1.View
      style={[OtpInput_styles_1.styles.container, containerStyle]}>
      <react_native_1.View
        style={[
          OtpInput_styles_1.styles.inputsContainer,
          inputsContainerStyle,
        ]}>
          ...
          .map((_, index) => {
            ...
            return (
              <>
                ...
                {index === 2 && (
                  //<react_native_1.Text>ttt</react_native_1.Text>
                  <react_native_1.View
                    style={{
                      alignSelf: 'center',
                    ...
                    <react_native_1.View
                      style={{
                        width: 6,
                        backgroundColor: 'rgba(66, 60, 73, 0.8)',
                        alignSelf: 'center',
                        height: 1.5,
                      }}
                    />
      ...
      <react_native_1.TextInput
        ...
        ref={inputRef}
        autoFocus={autoFocus}
        style={OtpInput_styles_1.styles.hiddenInput}
